...
# Folosim date reale pentru backtest
client = Client(API_KEY, API_SECRET)
client.API_URL = "https://api.binance.com/api"

# === DASHBOARD ===
app = dash.Dash(__name__)
app.title = "Crypto Bot - Dashboard Profesional"

app.layout = html.Div([
    html.H1("🤖 Dashboard Bot Tranzacționare BTC/USDT", style={'textAlign': 'center'}),

    # Tabs pentru LIVE Trading & Backtesting
...
def run_backtest(n_clicks, interval, period, rsi_overbought, rsi_oversold, macd_fast, macd_slow, macd_signal):
    ...
    fig.update_layout(title="Backtesting Strategie RSI + MACD")
    return results, fig
